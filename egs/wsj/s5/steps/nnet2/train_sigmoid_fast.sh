...
# meixu song:
# This script trains a fairly vanilla network with sigmoid nonlinearities.
# almost from "train_tanh_fast.sh", except that change "TanhComponent" to "SigmoidComponent"
# in "nnet.config & hidden.config"
...
SigmoidComponent dim=$hidden_layer_dim
