...
p=2
hidden_layer_dim=$pnorm_input_dim #  You may want this larger, e.g. 1024 or 2048.
...
EOF
  ...
  cat >>$dir/nnet.config <<EOF
AffineComponentPreconditionedOnline input-dim=$hidden_block_dim output-dim=$pnorm_input_dim $online_preconditioning_opts learning-rate=$initial_learning_rate param-stddev=$first_hidden_layer_stddev bias-stddev=$bias_stddev
