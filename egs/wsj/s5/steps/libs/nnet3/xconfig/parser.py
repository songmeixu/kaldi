...
config_to_layer = {
        ...
        'bn-relu-layer' : xlayers.XconfigBasicLayer,
        'bn-sigmoid-layer' : xlayers.XconfigBasicLayer,
        'bn-tanh-layer' : xlayers.XconfigBasicLayer,
        'bn-relu-renorm-layer' : xlayers.XconfigBasicLayer,
        'bn-sigmoid-renorm-layer' : xlayers.XconfigBasicLayer,
        'bn-tanh-renorm-layer' : xlayers.XconfigBasicLayer,
        ...
        'bnn-output-layer' : xlayers.XconfigBNNOutputLayer,
        'bnn-bn-output-layer' : xlayers.XconfigBNNOutputLayer,
        }
