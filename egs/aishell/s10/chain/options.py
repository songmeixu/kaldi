...
def _set_training_args(parser):
    ...
    parser.add_argument(
        "--train.lr", dest="learning_rate", help="learning rate", type=float
    )

    parser.add_argument(
        "--train.l2-regularize", dest="l2_regularize", help="l2 regularize", type=float,
    )

    parser.add_argument(
        "--train.dropout-schedule",
    ...
    parser.add_argument(
        "--train.ddp.world-size",
        dest="world_size",
        help="world size in DistributedDataParallel",
        default=1,
        type=int,
    )
