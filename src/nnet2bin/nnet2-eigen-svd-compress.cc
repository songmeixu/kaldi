...
int main(int argc, char *argv[]) {
  try {
    ...
    po.Register("dim", &dim, "Dimension to retain: colon-separated list of integers, e.g. 32:32:32:64");
    ...
    if (!SplitStringToIntegers(dim, ":", false, &dims)) {
    ...
    am_nnet.GetNnet().LimitRankOfEachLayerByEigen(dims);
