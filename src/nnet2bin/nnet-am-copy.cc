...
int main(int argc, char *argv[]) {
  try {
    ...
    po.Register("batchnorm-reset", &batchnorm_reset, "set BatchNormComponent total mean var cnt to 0");
    ...
    if (batchnorm_reset) am_nnet.GetNnet().ResetBatchNorm();
